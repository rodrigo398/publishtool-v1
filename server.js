...
const app = express();
mongoose.connect('mongodb://xxxx:xxxxx@xxxxx.mlab.com:19161/fbpage');
...
app.get('/logout', middleware.ensureLoggedIn(), (req, res) => {
  req.session.destroy();
  res.redirect('/');
});

app.get('*', middleware.ensureLoggedIn(), function(req, res) {
  res.render('app', { user: req.user });
});
